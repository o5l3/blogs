...
export default function About() {
  ...
  const services = [
    ...
    {
      title: '예측 시스템',
      desc: 'AI 기반 예측 분석으로 IT 인프라의 이상 징후를 사전에 감지하고 문제를 예방합니다.',
    },
    {
      title: '다양한 대상 디바이스',
  ...
  const problems = [
    { title: '장애 원인을 모른다', desc: 'PC가 느려지는데 원인 파악에 수일이 걸림' },
    { title: '사전 예방이 안 된다', desc: '문제가 터진 후에야 대응하는 반복' },
    { title: '데이터가 없다', desc: '감이 아닌 근거 기반의 IT 관리가 필요' },
    { title: '인력이 부족하다', desc: '소수 IT 인력으로 수백 대 PC를 관리해야 함' },
  ]
      ...
      <section className="bg-[#fafafa] border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6 py-20 md:py-28 text-center">
          ...
          <p className="text-base text-gray-400 max-w-lg mx-auto leading-relaxed">
            기업 IT 인프라 성능·장애 행위 기반 실시간 분석 및 AI 예측 시스템을 연구 개발합니다.
      ...
      <section className="border-y border-gray-100 bg-[#fafafa]">
        <div className="max-w-5xl mx-auto px-6 py-16 md:py-20">
          <div className="text-center mb-12">
            <p className="text-xs text-orange-500 font-bold tracking-widest uppercase mb-2">Problem</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {problems.map((p, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 text-center border border-gray-100">
                <div className="w-10 h-10 bg-red-50 text-red-400 rounded-full flex items-center justify-center mx-auto mb-4 text-sm font-bold">
                  {i + 1}
                </div>
