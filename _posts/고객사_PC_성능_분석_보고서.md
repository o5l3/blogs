---
title: "고객사 PC 성능 분석 보고서: 11가지 증상 유형과 해결 방안"
...
| **조치 방안** | 1) 문서 작업 중 입력한 문자열로 DNS 쿼리를 수행하는 것은 비정상적인 동작입니다. **Pennyroyal.exe 삭제**를 권장합니다. (한국 금융권 및 공공기관 사이트 접속 시 설치되는 프로그램이나, 사용하지 않을 시 삭제) 2) 저희 제품에서도 한글 등 DNS에서 사용하지 않는 문자열로 인한 DNS 쿼리 실패는 탐지 대상에서 제외 처리하였습니다. |
