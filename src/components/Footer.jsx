      ...
      <div className="max-w-5xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-3">
            <h4 className="text-[11px] text-gray-500 font-bold tracking-widest uppercase mb-4">Menu</h4>
            <ul className="space-y-2.5">
              <li><Link to="/category/report" className="text-[13px] text-gray-400 hover:text-orange-400 transition-colors">리포트</Link></li>
              <li><Link to="/category/tech" className="text-[13px] text-gray-400 hover:text-orange-400 transition-colors">기술</Link></li>
              <li><Link to="/about" className="text-[13px] text-gray-400 hover:text-orange-400 transition-colors">회사소개</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-[11px] text-gray-600">
